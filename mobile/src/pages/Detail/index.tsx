...
const Detail = () => {
    ...
    function onPressIconVoltar (){
        navigation.goBack();
    }

    function onClickButtonEmail (){
    ...
    function onClickButtonWhatsapp (){
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                    <TouchableOpacity  onPress={onPressIconVoltar}>
            ...
            <View style={styles.footer}>
                <RectButton style={styles.button} onPress={onClickButtonWhatsapp}>
                    <FontAwesome name="whatsapp" size={20} color="#FFF"/>
                    <Text style={styles.buttonText}>Whatsapp</Text>
                </RectButton>
                <RectButton style={styles.button} onPress={onClickButtonEmail}>
